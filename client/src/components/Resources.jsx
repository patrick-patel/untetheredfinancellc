          ...
          <Row>
            <Col>
              <div style={{margin: "auto", width: "75%"}}>
                ...
                <p style={{marginTop: -20}}><a style={{display: "table-cell"}} target={"_blank"} href={"https://www.upfolio.com/ultimate-bitcoin-guide"}>https://www.upfolio.com/ultimate-bitcoin-guide</a></p>

                <p>○   The What Bitcoin Did Podcast</p>
                <p style={{marginTop: -20}}>(The Ultimate Bitcoin 101 with Vijay Boyapati)</p>
                <p style={{marginTop: -20}}><a style={{display: "table-cell"}} target={"_blank"} href={"https://www.youtube.com/watch?v=SMtdXB6g6HI"}>https://www.youtube.com/watch?v=SMtdXB6g6HI</a></p>

                <p>○ Jameson Lopp's Resource List</p>
                <p style={{marginTop: -20}}><a style={{display: "table-cell"}} target={"_blank"} href={"https://www.lopp.net/bitcoin-information/getting-started.html"}>https://www.lopp.net/bitcoin-information/getting-started.html</a></p>
            ...
            <Col>
              ...
              <p style={{marginTop: -20}}><a style={{display: "table-cell"}} target={"_blank"} href={"https://www.youtube.com/watch?v=BODyqM-V71E"}>https://www.youtube.com/watch?v=BODyqM-V71E</a></p>
              ...
              <p style={{marginTop: -20}}><a style={{display: "table-cell"}} target={"_blank"} href={"https://www.youtube.com/watch?v=wdJFeSY8UVk"}>https://www.youtube.com/watch?v=wdJFeSY8UVk</a></p>

              <p>○   The What is Money? Podcast</p>
              <p style={{marginTop: -20}}>(The Saylor Series)</p>
              <p style={{marginTop: -20}}><a style={{display: "table-cell"}} target={"_blank"} href={"https://www.youtube.com/watch?v=4rvTppy1qLI"}>https://www.youtube.com/watch?v=4rvTppy1qLI</a></p>

              <p>○   The What is Money? Podcast</p>
              <p style={{marginTop: -20}}>(The Booth Series)</p>
              <p style={{marginTop: -20}}><a style={{display: "table-cell"}} target={"_blank"} href={"https://www.youtube.com/watch?v=_ZyFv_BUTPg"}>https://www.youtube.com/watch?v=_ZyFv_BUTPg</a></p>
            </Col>
          </Row>
        </Container>
      </div>
