          ...
          <Card>
            <Chart
              ...
              data={[
                ...
                [3, coldWallet[2], casaWallet[2], asicFund[2], taxFund[2]],
                [4, coldWallet[3], casaWallet[3], asicFund[3], taxFund[3]],
                [5, coldWallet[4], casaWallet[4], asicFund[4], taxFund[4]],
                [6, coldWallet[5], casaWallet[5], asicFund[5], taxFund[5]],
                [7, coldWallet[6], casaWallet[6], asicFund[6], taxFund[6]],
                [8, coldWallet[7], casaWallet[7], asicFund[7], taxFund[7]],
                [9, coldWallet[8], casaWallet[8], asicFund[8], taxFund[8]],
                [10, coldWallet[9], casaWallet[9], asicFund[9], taxFund[9]],
                [11, coldWallet[10], casaWallet[10], asicFund[10], taxFund[10]],
